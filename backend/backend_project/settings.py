...
SECRET_KEY = 'django-insecure-23(-ow8+iq2hot*(u$b5*zn1)k@d8_mudf9(k8idkjfog^7(z@'
...
AZURE_CONTAINER = os.environ.get('AZURE_CONTAINER', 'photos')

# Base URL for all photos
AZURE_BLOB_BASE_URL = (
